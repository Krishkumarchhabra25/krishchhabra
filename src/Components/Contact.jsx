  ...
  return (
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
           ...
           <form action="https://getform.io/f/bdrrwpnb" method="POST" className="xl:pl-10 2xl:pl-20">
             <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
               <div className="mb-4">
                  <label htmlFor="name" className="label reveal-up">
                    Name
                  </label>
                  <input type="text" name="name" id="name" autoComplete="name" required placeholder="krish chhabra" className="text-field reveal-up" />
                </div>
                ...
                <input type="email" name="email" id="email" autoComplete="email" required placeholder="krishchhabra@gmail.com" className="text-field reveal-up" />
              </div>
             ...
             <div className="mb-4">
               ...
               <textarea name="message" placeholder="Hi!" id="message" required className="text-field resize-y min-h-32 max-h-80 reveal-up">
